...
export function buildDevRoom() {
  ...
  // Pass 5 creatures (from the registry list, so new kinds appear without editing this lab)
  PASS5_ENEMIES.forEach((k, i) => defs.push({ type: 'custom_entity', factory: g => new DevSpawnerTotem(g, 26.0 + i * 2, 47.0, k, `Spawn ${k}`) }));
