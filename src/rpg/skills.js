...
N({id:'cleanchamber',path:0,x:2,y:1,type:'mod',name:'Clean Chamber',desc:()=>'The first successful shot after a completed reload gains 25% shared weapon power.',req:['quickdraw']}),
...
N({id:'highnoon',path:0,x:1,y:4,type:'key',name:'High Noon',desc:()=>'Reloading an empty magazine adds 100% shared weapon power: one piercing revolver opening or three empowered rifle rounds.',req:['quickdraw'],pathMin:7,lvl:12}),
