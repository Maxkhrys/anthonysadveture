...
import { KIT, kitParts } from './kit.js';
...
// the authoritative model boxes for any buildable id (kit pieces come from kit.js)
export const modelParts = type => KIT[type] ? kitParts(type) : pieceParts(type);
