...
export class KilnRegent extends Entity {
 ...
 defeat(){const g=this.g;g.flags.emberBoss=true;g.setSignal('ew.boss',true,true);g.sealRoom('heart',false);g.bossActive=null;g.ui.bossBar(null);this.clearMarks();g.gainXp(600);const id={samurai:'dawnbringer',archer:'starfallcrossbow',witch:'orbitinggrimoire',soulbound:'lanternchain'}[g.inv.cls];g.spawn(new GearDrop(g,this.x,this.z+1.5,makeNamed(id,12)));g.ui.banner('THE FURNACE FALLS QUIET','The Ember Voice',3);g.save();this.remove();}
